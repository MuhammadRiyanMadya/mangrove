...
class dataExt():
    ...
    def __init__(self, fileName):
        ...
        self.MainKey = 'R201' #by default refers to R201, please CHANGE this accordingly !
                ...
                if '.' in files:
                    ...
                    if len(idx[0]) != 0:
                        ...
                        if self.MainKey == 'Key1':
                            ...
                            MIL = self.dataBrowser(self.df, 'Ton pp/Kg cat', formatNew = 'FRONT', searchObj = 'Bulk3')
                            Rate = self.dataBrowser(self.df, ' Ton / Hr','Ton/Hr', formatNew = 'FRONT', searchObj = 'Bulk3')
                        
                        mydict = {'Date': DT, 'GRADE': GR, 'CATZ': CATZ, 'TC222': TC222, 'FI222': FI222, 'MIL': MIL, 'RATE': Rate}
...
myd = dataExt('Catz Mileage 2024')
myd.MainKey = 'Key1'
myd.xlsxIdentifier(r'C:\Users\mrm\Documents\Production Engineering\Catalyst perform tracer\2024', UniversalKeyBulk)
